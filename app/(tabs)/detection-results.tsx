...
const styles = StyleSheet.create({
  container: { flex: 1, backgroundColor: '#0F2E08', padding: 20 },
  header: { alignItems: 'center', marginTop: 30, marginBottom: 24, backgroundColor: 'rgba(26, 61, 15, 0.4)', paddingVertical: 20, paddingHorizontal: 16, borderRadius: 16, borderWidth: 1, borderColor: 'rgba(76, 175, 80, 0.2)' },
  title: { fontSize: 28, fontWeight: '800', color: '#FFFFFF', letterSpacing: 0.5 },
  subtitle: { fontSize: 14, color: 'rgba(255, 255, 255, 0.8)', marginTop: 4 },
  section: { marginBottom: 24 },
  label: { fontSize: 16, fontWeight: '700', color: '#4CAF50', marginBottom: 10 },
  input: { backgroundColor: '#1A3D0F', padding: 14, borderRadius: 12, fontSize: 15, borderWidth: 1, borderColor: 'rgba(76, 175, 80, 0.3)', marginBottom: 12, color: '#FFFFFF' },
  pickerWrapper: { backgroundColor: '#1A3D0F', borderRadius: 12, borderWidth: 1, borderColor: 'rgba(76, 175, 80, 0.3)', marginBottom: 12 },
  predictionCard: { backgroundColor: 'rgba(76, 175, 80, 0.15)', borderRadius: 12, padding: 14, marginBottom: 12, borderLeftWidth: 5, borderLeftColor: '#4CAF50', borderWidth: 1, borderColor: 'rgba(76, 175, 80, 0.3)' },
  predictionLabel: { fontSize: 12, fontWeight: '700', color: '#4CAF50', textTransform: 'uppercase', letterSpacing: 0.3, marginBottom: 6 },
  predictionDate: { fontSize: 17, fontWeight: '700', color: '#FFFFFF', marginBottom: 6 },
  predictionShelfLife: { fontSize: 13, color: 'rgba(255, 255, 255, 0.8)', fontWeight: '500' },
  confirmButton: { backgroundColor: '#4CAF50', paddingVertical: 16, borderRadius: 14, alignItems: 'center', marginTop: 12, marginBottom: 12, shadowColor: '#4CAF50', shadowOffset: { width: 0, height: 4 }, shadowOpacity: 0.35, shadowRadius: 8, elevation: 6 },
  ...
  cancelButtonText: { color: 'rgba(255, 255, 255, 0.6)', fontSize: 14, fontWeight: '600' },
});